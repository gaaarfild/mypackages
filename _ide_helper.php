...
namespace {
    ...
    class Conf extends \Gaaarfild\LaravelConf\ConfFacade{
        ...
        public static function setFile($file){
            return \Gaaarfild\LaravelConf\Conf::setFile($file);
        }
         ...
         */
        public static function forget($key){
            return \Gaaarfild\LaravelConf\Conf::forget($key);
        }
    ...
    class Notifications extends \Gaaarfild\LaravelNotifications\NotificationsFacade{
         ...
         * @static 
         */
        public static function add($message, $type, $group = '0'){
        ...
        public static function info($message, $group = '0'){
            return \Gaaarfild\LaravelNotifications\Notifications::info($message, $group);
        }
         ...
         * @static 
         */
        public static function success($message, $group = '0'){
            return \Gaaarfild\LaravelNotifications\Notifications::success($message, $group);
        }
         ...
         * @static 
         */
        public static function warning($message, $group = '0'){
            return \Gaaarfild\LaravelNotifications\Notifications::warning($message, $group);
        }
         ...
         * @static 
         */
        public static function danger($message, $group = '0'){
            return \Gaaarfild\LaravelNotifications\Notifications::danger($message, $group);
        }
         ...
         * @static 
         */
        public static function error($message, $group = '0'){
            return \Gaaarfild\LaravelNotifications\Notifications::error($message, $group);
        }
        ...
        public static function has(){
            return \Gaaarfild\LaravelNotifications\Notifications::has();
        }
         ...
         * @static 
         */
        public static function toHTML($custom_template = null){
            return \Gaaarfild\LaravelNotifications\Notifications::toHTML($custom_template);
        }
    ...
    class Pinger extends \Gaaarfild\LaravelPinger\PingerFacade{
         ...
         * @static 
         */
        public static function pingPingOMatic($title, $url, $rss = null, $params = array()){
            return \Gaaarfild\LaravelPinger\Pinger::pingPingOMatic($title, $url, $rss, $params);
        }
         ...
         * @static 
         */
        public static function ping($service_url, $title, $url, $rss = null){
            return \Gaaarfild\LaravelPinger\Pinger::ping($service_url, $title, $url, $rss);
        }
    ...
    class Title extends \Gaaarfild\LaravelTitle\TitleFacade{
         ...
         * @static 
         */
        public static function append($segment){
            return \Gaaarfild\LaravelTitle\Title::append($segment);
        }
         ...
         * @static 
         */
        public static function prepend($segment){
            return \Gaaarfild\LaravelTitle\Title::prepend($segment);
        }
         ...
         * @static 
         */
        public static function render($delimiter = null, $no_additions = false){
            return \Gaaarfild\LaravelTitle\Title::render($delimiter, $no_additions);
        }
         ...
         * @static 
         */
        public static function renderr($delimiter = null, $no_additions = false){
            return \Gaaarfild\LaravelTitle\Title::renderr($delimiter, $no_additions);
        }
         ...
         */
        public static function get(){
            return \Gaaarfild\LaravelTitle\Title::get();
        }
         ...
         */
        public static function toJson(){
            return \Gaaarfild\LaravelTitle\Title::toJson();
        }
         ...
         */
        public static function has(){
            return \Gaaarfild\LaravelTitle\Title::has();
        }
         ...
         */
        public static function clear(){
            return \Gaaarfild\LaravelTitle\Title::clear();
        }
         ...
         * @static 
         */
        public static function make($segments, $delimiter = '-', $suffix = '', $prefix = '', $on_empty = ''){
            return \Gaaarfild\LaravelTitle\Title::make($segments, $delimiter, $suffix, $prefix, $on_empty);
        }
         ...
         */
        public static function macro($name, $macro){
            \Gaaarfild\LaravelTitle\Title::macro($name, $macro);
        }
         ...
         */
        public static function hasMacro($name){
            return \Gaaarfild\LaravelTitle\Title::hasMacro($name);
        }
